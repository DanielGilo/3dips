...
def get_sds_loss(z0_student, teacher, text_embeddings, teacher_guidance_scale, eps, timestep, w_t, index_mask=None):
    if index_mask is None:
        index_mask = torch.ones_like(z0_student, dtype=torch.float32)
